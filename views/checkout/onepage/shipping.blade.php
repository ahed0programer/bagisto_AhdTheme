    ...
    <div class="form-container">
        ...
        <div class="shipping-methods">
            ...
            <div class="control-group" :class="[errors.has('shipping-form.shipping_method') ? 'has-error' : '']">
                        ...
                        <div class="checkout-method-group mb-20">
                            <div class="line-one">
                                <label class="radio-container">
                                    <input v-validate="'required'" type="radio" id="{{ $rate->method }}" name="shipping_method" onclick="selectMethod('{{$rate->method }}')" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.shipping-method') }}&quot;" value="{{ $rate->method }}" v-model="selected_shipping_method" @change="methodSelected()">
                ...
                <span id="shipping_method" class="control-error" v-if="errors.has('shipping-form.shipping_method')">
