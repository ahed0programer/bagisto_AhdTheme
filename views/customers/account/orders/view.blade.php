    ...
    <div class="account-layout col-xl-9 col-lg-9">
        ...
        <div class="container mt-4">
            <ul class="nav nav-tabs" id="myTabs">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab1">{{ __('shop::app.customer.account.order.view.info') }}</a>
                </li>

                @if ($order->invoices->count())
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab2">{{ __('shop::app.customer.account.order.view.invoices') }}</a>
                    </li>
                @endif

                @if ($order->shipments->count())
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab3">{{ __('shop::app.customer.account.order.view.shipments') }}</a>
                    </li>
                @endif

                @if ($order->refunds->count())
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tab4">{{ __('shop::app.customer.account.order.view.refunds') }}</a>
                    </li>
                @endif
            </ul>
